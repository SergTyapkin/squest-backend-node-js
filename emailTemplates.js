function _default_template(avatarUrl, fullName, htmlContent) {
    let avatarDiv = '';
    if (avatarUrl) {
...
export function restorePassword(avatarUrl, fullName, code) {
    return _default_template(avatarUrl, fullName, `
...
export function loginByCode(avatarUrl, fullName, code) {
    return _default_template(avatarUrl, fullName, `
...
export function confirmEmail(avatarUrl, fullName, code) {
    return _default_template(avatarUrl, fullName, `
